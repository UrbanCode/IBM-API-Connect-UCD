...
try {
	...
	println "[Possible Solution] Confirm the server, organization, and definition properties are correct."
	ex.printStackTrace()
	System.exit(1)
}
...
if (output.contains("ERROR Use 'apic login' to log into")){
	...
	println "[Error] Unable to run the 'apic drafts:push' command because the $defintion file could not be found."
